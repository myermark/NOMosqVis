...
tiff(filename = "./2020/Gravid/Maps/Aedes/041420_Gravid_Aedes_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type = "cairo")
map + geom_point(data = summ_grav, pch=21, stroke = 1, aes(x=long, y= lat, fill = aed_total), size = 3)  + 
  ...
  ggtitle("04/14/2020 Gravid Traps") +
...
tiff(filename = "./2020/Gravid/Maps/Culex/041420_Gravid_Culex_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type="cairo")
...
tiff(filename = "./2020/CDC Light/Maps/041620_Light_Aedes_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type = "cairo")
map + geom_point(data = summ_light, pch=21, stroke = 1, aes(x=long, y= lat, fill = aed_total), size = 3)  + 
                  ...
                  guides(size = F) +
                  labs(x = "Longitude", y = "Latitude") + 
                  ggtitle("04/16/2020 Light Traps") +
                  theme(axis.title.x = element_text(color = "black", size = 14, face = "bold"),
                        axis.title.y = element_text(color = "black", size = 14, face = "bold"), 
                        plot.title = element_text(size=20, face = "bold"))
#+ geom_text(x=(borders[3] + (newwidth * 0.5)), y=(borders[2] - (newheight * 0.05)), label = "2019 Gravid Traps") 
...
tiff(filename = "./2020/CDC Light/Maps/041620_Light_Culex_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type = "cairo")
...
tiff(filename = "./2020/CDC Light/Maps/041620_Light_Anopheles_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type = "cairo")
...
#BG traps with Aedes
tiff(filename = "./2020/BG Sentinel/Maps/Aedes/041420_BG_Aedes_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type="cairo")
...
#BG traps with Culex
tiff(filename = "./2020/BG Sentinel/Maps/Culex/041420_BG_Culex_R.tiff", height = 8, width = 9, units = "in", res = 120, compression = "lzw", type="cairo")
